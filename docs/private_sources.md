...
## 2026-09-17 — audyt przydatności kompilacji

Skrypt `scripts/build_private_gis_usefulness.py` tworzy prywatny raport warstw i wzmiankowanych obiektów z hashami plików. Dopasowanie nazwy, opisu zadania lub etykiety grupy służy odkrywaniu dowodów; nie potwierdza połączenia elektrycznego. Wyniki pozostają w `data/private/reviews/gis_usefulness_2026-09-17_v1`. Ogólne wyjaśnienie wkładu GIS i niezależnej próbki OSM: [GIS i OSM](18_gis_osm_integration.md). NEED-012 pozostaje otwarty.
