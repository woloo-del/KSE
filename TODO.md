...
- **KSE-033 — Prywatne obserwacje i wspólna infrastruktura przyłączeniowa** (P0, W toku). Wariant v2 obejmuje historyczne parametry i deklaracje kompletności. Następnie sprawdzić rzeczywiste dowody pilota względem kontraktu, zapisać braki i przygotować następny raport projektu; pełna baza i kontrola dostępu pozostają otwarte.
...
- Odpowiedzialność: Użytkownik + Codex.
- Następny krok: Wariant v2 obejmuje historyczne parametry i deklaracje kompletności. Następnie sprawdzić rzeczywiste dowody pilota względem kontraktu, zapisać braki i przygotować następny raport projektu; pełna baza i kontrola dostępu pozostają otwarte.
