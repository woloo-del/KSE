...
- **KSE-033 — Prywatne obserwacje i wspólna infrastruktura przyłączeniowa** (P0, W toku). Rejestr braków pilota i potrzeb użytkownika jest w information_requests.json oraz raporcie. Aktualizować po dostarczeniu materiału; kontynuować dostępne źródła niezależnie od niedostępnej ekspertyzy.
...
- Odpowiedzialność: Użytkownik + Codex.
- Następny krok: Rejestr braków pilota i potrzeb użytkownika jest w information_requests.json oraz raporcie. Aktualizować po dostarczeniu materiału; kontynuować dostępne źródła niezależnie od niedostępnej ekspertyzy.
