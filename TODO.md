...
- **KSE-033 — Prywatne obserwacje i wspólna infrastruktura przyłączeniowa** (P0, W toku). Plikowe odtwarzanie historii z manifestem i ochroną prywatnych wejść gotowe. Następnie dodać historię parametrów przyłącza i jawnych deklaracji kompletności; zweryfikować realne przypisania po uzyskaniu dowodów.
...
- Odpowiedzialność: Użytkownik + Codex.
- Następny krok: Plikowe odtwarzanie historii z manifestem i ochroną prywatnych wejść gotowe. Następnie dodać historię parametrów przyłącza i jawnych deklaracji kompletności; zweryfikować realne przypisania po uzyskaniu dowodów.
