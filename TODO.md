...
- **KSE-033 — Prywatne obserwacje i wspólna infrastruktura przyłączeniowa** (P0, W toku). Integracja historii z licznikiem przypisań gotowa i przetestowana. Następnie dodać wersjonowane wejście i bezpieczne odtwarzanie z manifestem; później historię parametrów oraz deklaracji kompletności.
...
- Odpowiedzialność: Użytkownik + Codex.
- Następny krok: Integracja historii z licznikiem przypisań gotowa i przetestowana. Następnie dodać wersjonowane wejście i bezpieczne odtwarzanie z manifestem; później historię parametrów oraz deklaracji kompletności.
